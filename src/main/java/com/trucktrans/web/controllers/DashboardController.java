...
public class DashboardController extends AbstractRestController<Object>{
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response planMyTransportation(@InjectParam WUserBooking userBooking){
		System.out.println("executed the controller");
		Response.ok(dashboardService.planTransportation(userBooking)).build();
		return null;
	}
